...
do
	...
	local pluginInstance = plugin or (script:FindFirstAncestorWhichIsA("Plugin"))
	if pluginInstance and pluginInstance.Unloading then
		pcall(function()
